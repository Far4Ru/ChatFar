<?php
	...
	if(isset($_POST['registration_window_flag'])){
		echo "
		<div style='width:50%;float:left'>
			<div style='display: table-cell;vertical-align: middle;' class='login_window_block' ondbclick='return false' onmousedown='return false' onselectstart='return false' id='language_mark8'>
				Login
			</div>
			<div  class='login_window_block'>
				<input type='text' class='window_block_input' tabindex='4'>
			</div>
			<div style='display: table-cell;vertical-align: middle;' class='login_window_block' ondbclick='return false' onmousedown='return false' onselectstart='return false' id='language_mark9'>
				Mail
			</div>
			<div  class='login_window_block'>
				<input type='text' class='window_block_input' tabindex='5'>
			</div>
		</div>
		<div style='float:right'>
			<div style='display: table-cell; vertical-align: middle; width:50%;' id='right_window_block' align='center'>
				...
				<input type='button' style='width:50%;' value='Enter' onclick='send_data_log()' id='language_mark10'>
			</div>
		</div>
			<script>
